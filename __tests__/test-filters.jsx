...
var daterangeFilter = TestUtils.renderIntoDocument(
  <Filters.DaterangeFilter attr='date'/>
);
...
describe('Daterange Filter', () => {
  ...
  it('builds Query object correctly', () => {
    expect(daterangeFilter.getQuery()).toEqual({start: '2001-01-01', end: '2001-12-31', group: 'month'});
  });
