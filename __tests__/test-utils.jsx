...
describe("Utils Methods", () => {
  ...
  it("Builds daterange query", () => {
    expect(
      Utils.getDaterangeQuery(moment("01012001", "DDMMYYYY"), moment("02022001", "DDMMYYYY"))
    ).toBe("2001-01-01to2001-02-02");
  });

  it("Builds date object based on daterange query", () => {
    expect(Utils.parseDaterange("2001-01-01to2001-02-02")).toEqual({
      start: moment("2001-01-01"),
      end: moment("2001-02-02"),
    });
  ...
  it("Generates date series", () => {
    // Grouping by day
    var series = Utils.generateDateSeries(
      moment("01012001", "DDMMYYYY"),
      moment("08012001", "DDMMYYYY"),
      1,
      "day"
    );
    ...
    // Grouping by month
    series = Utils.generateDateSeries(
      moment("01012001", "DDMMYYYY"),
      moment("01052001", "DDMMYYYY"),
      1,
      "month"
    );
    ...
    series = Utils.generateDateSeries(
      moment("01012000", "DDMMYYYY"),
      moment("01012008", "DDMMYYYY"),
      2,
      "year"
    );
    allDatesCorrect = series.every((date, index) => {
    ...
    series = Utils.generateDateSeries(
      moment("01012004", "DDMMYYYY"),
      moment("01012002", "DDMMYYYY"),
      2,
      "year"
    );
